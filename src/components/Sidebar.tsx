    ...
    <>
      ...
      `}>
        ...
        <nav className="flex-1 overflow-y-auto py-6 flex flex-col gap-1">
          ...
          <Link href="/configuracoes" onClick={closeMenu} className={`px-8 py-4 flex items-center gap-3 font-bold transition-all ${isActive('/configuracoes')}`}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.18-.08a2 2 0 0 0-2 2v.44a2 2 0 0 0 2 2h.18a2 2 0 0 1 1 1.73l-.25.43a2 2 0 0 1 0 2l.08.18a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.18.08a2 2 0 0 0 2-2v-.44a2 2 0 0 0-2-2h-.18a2 2 0 0 1-1-1.73l.25-.43a2 2 0 0 1 0-2l-.08-.18a2 2 0 0 0-2-2z" />
