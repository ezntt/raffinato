      ...
      >
        ...
        <div className="p-6 border-t border-gray-100 bg-gray-50 space-y-4">
          ...
          <button 
            ...
            className="w-full flex items-center justify-center gap-2 text-red-600 hover:text-red-700  hover:bg-red-50 p-2 rounded-lg transition-colors font-bold text-sm border border-transparent hover:border-red-100"
          >
